...
{
	//coco数据集的名称文件，80类
	string classesFile = "E:\\VS2019\\Project\\model\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "E:\\VS2019\\Project\\model\\yolov3.cfg";
	//权重
	String weights = "E:\\VS2019\\Project\\model\\yolov3.weights";

	cv::dnn::Net net = cv::dnn::readNetFromDarknet(yolov3_model, weights);

	VideoCapture cap(YOLOV3_VIDEO);
	VideoWriter yoloV3Video("yoloV3Result.avi", CV_FOURCC('M', 'P', '4', '2'), 30, Size(320, 568));
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "E:\\VS2019\\Project\\model\\openpose_pose_coco.prototxt";
	String modelBin = "E:\\VS2019\\Project\\model\\pose_iter_440000.caffemodel";
	...
	VideoCapture cap;
	VideoWriter openposeVideo("openposeResult.avi", CV_FOURCC('M', 'P', '4', '2'), 30, Size(320, 568));
